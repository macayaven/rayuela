...
def main():
    ...
    works = [
        ...
        (
            ...
            "mutis_trampsteamer.epub",
        ),
        (
            "mutis_nievealmirante",
            "Mutis",
            "La nieve del almirante",
            "mutis_nievealmirante.epub",
        ),
        (
            "cabrerainfante_trestistestigres",
            "Cabrera Infante",
            "Tres tristes tigres",
            "cabrerainfante_trestistestigres.epub",
        ),
        (
            "bolano_detectivessalvajes",
            "Bolaño",
            "Los detectives salvajes",
            "bolano_detectivessalvajes.epub",
        ),
    ]
    ...
    if downloaded:
        print("\n✓ Downloaded:")
        for author, title, path, _source in downloaded:
